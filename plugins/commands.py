...
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, InputMediaAnimation, ChatJoinRequest
            ...
            [
                [
                    InlineKeyboardButton(
                        "〽️ Main Channel", url="https://t.me/joinchat/Fhcssgw5H8wwMDBl")
                ],
                [
                    InlineKeyboardButton("Movies", url="https://t.me/malayayalies"),
...
async def link_shortener(client, update, message):
